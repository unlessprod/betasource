/* 
ÐÐµ Ñ‚Ñ€Ð¾Ð³Ð°Ð¹ ÑÑ‚Ð¾Ñ‚ Ñ„Ð°Ð¹Ð», Ñ‚ÑƒÑ‚ Ð»Ð¾Ð³Ð¸ÐºÐ° ÑÐ°Ð¹Ñ‚Ð°, 
Ñ ÑÐ´ÐµÐ»Ð°Ð» ÐºÐ¾Ð½Ñ„Ð¸Ð³ Ñ‡Ñ‚Ð¾ Ð±Ñ‹ Ñ‚Ñ‹ Ð¼Ð¾Ð³ Ð¼ÐµÐ½ÑÑ‚ÑŒ Ð´Ð°Ð½Ð½Ñ‹Ðµ
      ...
      methods: {
        ...
        startPlay() {
          ...
          setTimeout(() => {
            ...
            setInterval(() => {
              awesomeEffect({
                el: document.querySelector('.ibo-page-copyright'),
